...
const displayQuantityInfo= (added_removed, quantity_info)=>{
...
q_checkbox_all.forEach(q_checkbox=>{
    q_checkbox.addEventListener('change', e=>{
        displayQuantityInfo(q_checkbox.checked, d.querySelectorAll(`#${q_checkbox.id.replace('q-checkbox-', 'quantity-')}`));
    });
});
